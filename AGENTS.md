...
Quick index for AI agents working in this workspace.

## 📋 Start Here

1. **[copilot-instructions.md](.github/copilot-instructions.md)** — Complete METIS system guide
2. **[STYLE-GUIDE.instructions.md](.github/instructions/STYLE-GUIDE.instructions.md)** — Authoritative coding rules
...
See copilot-instructions.md § "Essential Commands"
