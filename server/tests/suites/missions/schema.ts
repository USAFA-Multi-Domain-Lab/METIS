  ...
  return describe('Mission Schema Validation', function () {
    ...
    it('Creating a mission with all the correct properties should save the mission to the database', async function () {
      ...
      try {
        ...
        let savedMissionJson: TCommonMissionJson = missionDoc.toJSON()
        // Make sure the database generated an ObjectId for the mission's seed property
        let seedIsObjectId: boolean = mongoose.isObjectIdOrHexString(
          savedMissionJson.seed,
        )
        ...
        // be an ObjectId that was generated by the database
        expect(seedIsObjectId).to.equal(true)
        // The retrieved mission should have the same
