...
import type { TMissionComponentArg } from '@shared/target-environments/parameters/mission-component/MissionComponentTargetParameter'
...
type TArgForce_P = {
   ...
   */
  existsInTargetArguments: boolean
  /**
