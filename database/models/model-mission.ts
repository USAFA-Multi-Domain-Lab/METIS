...
// This is called when a find query
// is made to filter out all of the
// _id fields that are not used. These
// fields are autogenerated by MongoDB
// and they are not needed anywhere in
// the application.
const filterOutUnusedIDs = (missions: any): void => {
  ...
  if (missions === null) {
    return
  } else if (missions instanceof Array) {
