...
> For a workspace-wide index of instruction files, see [AGENTS.md](../../AGENTS.md). This document remains the authoritative source for the style rules described below.
